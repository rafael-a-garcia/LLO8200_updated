...
9a. Which predictors (if any) are risk factors (they increase the odds of dying of CVDD)? How do you know? (2pts)


9b. Which predictors (if any) are protective factors (they decrease the odds of defaulting)? How do you know? (2pts)
...
11. Calculate the accuracy, sensitivity and specificity of your model. (6pts) 
```{r}
...
13. How well did this model perform overall? Is there anything you are unsatisfied with? What might you do to improve the model? (2pts) 