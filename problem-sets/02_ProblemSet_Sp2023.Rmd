---
title: "Problem Set 2: Conditional Means"
...
2. Identify the variable type and scale of measurement of our outcome: `md_earn_wne_p6`. Plot the distribution - making sure you choose an appropriate univariate plot. (3pts)
```{r}

```

2a. Tell me at least two things that this distribution shows you about the outcome. (2pts)
...
5a. Provide one sentence interpreting this RMSE in context (don't forget your units). (2pts)




6. Let's look at one potential predictor: public vs. private (`control`). We know that, on average, private schools tend to cost more. If a school costs more, we would hope its alumni eventually earn more, right? First, let's examine the distribution of this predictor. 

Identify the variable type and scale of measurement of `control`. Plot the distribution - making sure you choose an appropriate univariate plot. (3pts)
```{r}
...
9. Calculate a summary measure of the error in your predictions using this one predictor (RMSE). (5pts) 
```{r}

```

9a. Provide one sentence interpreting this RMSE in context (don't forget your units). (2pts) 
...
10. Now, I want you to add in a second predictor of your choosing. For this question, list the variable and why you think it might be a good predictor for our outcome (explain why you chose that variable and not another). (2pts) 



11. Identify the variable type and scale of measurement of your new predictor. Plot your new predictor variable using the appropriate *univariate* plot (you're just plotting the new predictor alone here; nothing combined yet) (4pts) 
```{r}
...
12. Calculate the mean of the outcome for each level of our *combined* predictor variables. (5pts)
```{r}
...
14. Calculate a summary measure of the error in your predictions using these two predictors (RMSE). (4pts) 
```{r}

```


14a.  Provide one sentence interpreting this RMSE in context (don't forget your units). (2pts)  
