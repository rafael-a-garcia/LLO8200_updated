---
title: "Using Regression for Prediction - LMS Module 5 (part 1)"
...
ad_test<-lm_results%>% ## start with the results
  ...
  rename(pred_educ=.pred)%>%  ## rename the prediction
