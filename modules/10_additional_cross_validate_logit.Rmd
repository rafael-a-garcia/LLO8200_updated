...
## Important: for this to work you need to define your outcome as a factor with descriptive factor levels. If nothing else, just use "Yes" and "No" to describe outcome names. 
